...
def generate_io_for_scenario_2():
    ...
    for fold in s2.fold:
        for vid in s2.vids(data_type)[fold]:
            ...
            kwargs['prefix'] = prefix
            kwargs['data_type'] = data_type
            kwargs['fold_sub_vid_pairs'] = [(fold, sub, vid) for sub in s2.subs(data_type)[fold]]
            kwargs_list.append(kwargs)
...
def generate_io_for_scenario_3():
    ...
    kwargs['prefix'] = prefix
    kwargs['data_type'] = data_type
    kwargs['fold_sub_vid_pairs'] = [(0, sub, vid) for sub in s3.subs(data_type)[0] for vid in [0, 3, 4, 21]]
    kwargs_list.append(kwargs)
    ...
    kwargs['prefix'] = prefix
    kwargs['data_type'] = data_type
    kwargs['fold_sub_vid_pairs'] = [(0, sub, vid) for sub in s3.subs(data_type)[0] for vid in [4, 10, 21, 22]]
    kwargs_list.append(kwargs)
    ...
    kwargs['prefix'] = prefix
    kwargs['data_type'] = data_type
    kwargs['fold_sub_vid_pairs'] = [(3, sub, vid) for sub in s3.subs(data_type)[3] for vid in [10, 16, 20, 22]]
    kwargs_list.append(kwargs)
    ...
    kwargs['prefix'] = prefix
    kwargs['data_type'] = data_type
    kwargs['fold_sub_vid_pairs'] = [(3, sub, vid) for sub in s3.subs(data_type)[3] for vid in [0, 3, 16, 20]]
    kwargs_list.append(kwargs)
...
def generate_io_for_scenario_4():
    ...
    for fold in s4.fold:
        for vid in s4.vids(data_type)[fold]:
            ...
            kwargs['prefix'] = prefix
            kwargs['data_type'] = data_type
            kwargs['fold_sub_vid_pairs'] = [(fold, sub, vid) for sub in s4.subs(data_type)[fold]]
            kwargs_list.append(kwargs)
