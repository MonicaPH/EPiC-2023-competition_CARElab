...
def train_for_scenario_3():
    lst = [('arousal', 'arousal_03421'),
...
if __name__ == '__main__':
    ...
    if scenario == 1:
        train_for_scenario_1()
    elif scenario == 2:
        train_for_scenario_2()
    elif scenario == 3:
        train_for_scenario_3()
    else:
        train_for_scenario_4()
